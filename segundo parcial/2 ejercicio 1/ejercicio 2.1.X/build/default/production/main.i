...
void main(void) {
    ...
    while(1){
        LATBbits.LB0=1;
        if(PORTAbits.RA0 == 1 ){LATD = display_array[10];}
        if(PORTAbits.RA1 == 1 ){LATD = display_array[1];}
        if(PORTAbits.RA2 == 1 ){LATD = display_array[2];}
        if(PORTAbits.RA3 == 1 ){LATD = display_array[3];}
        _delay((unsigned long)((.25)*(20000000/4000.0)));
        LATBbits.LB0=0;

        LATBbits.LB2=1;
        if(PORTAbits.RA0 == 1 ){LATD = display_array[11];}
        if(PORTAbits.RA1 == 1 ){LATD = display_array[4];}
        if(PORTAbits.RA2 == 1 ){LATD = display_array[5];}
        if(PORTAbits.RA3 == 1 ){LATD = display_array[6];}
        _delay((unsigned long)((.25)*(20000000/4000.0)));
        LATBbits.LB2=0;

        LATBbits.LB4=1;
        if(PORTAbits.RA0 == 1 ){LATD = display_array[12];}
        if(PORTAbits.RA1 == 1 ){LATD = display_array[7];}
        if(PORTAbits.RA2 == 1 ){LATD = display_array[8];}
        if(PORTAbits.RA3 == 1 ){LATD = display_array[9];}
        _delay((unsigned long)((.25)*(20000000/4000.0)));
        LATBbits.LB4=0;

        LATBbits.LB6=1;
        if(PORTAbits.RA0 == 1 ){LATD = display_array[13];}
        if(PORTAbits.RA1 == 1 ){LATD = display_array[14];}
        if(PORTAbits.RA2 == 1 ){LATD = display_array[0];}
        if(PORTAbits.RA3 == 1 ){LATD = display_array[15];}
        _delay((unsigned long)((.25)*(20000000/4000.0)));
        LATBbits.LB6=0;
