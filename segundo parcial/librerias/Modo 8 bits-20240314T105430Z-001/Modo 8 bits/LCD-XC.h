...
#define _XTAL_FREQ 20000000L                                  // device clock frequency (_XTAL_FREQ) used by XC8 for __delay_ms()
...
#define mCURSOR_BLINK       LCDPutCmd(LCD_CURSOR_BLINK)
...
#define LCDPutChar          LCDPutChar                       // legacy support
    ...
    #define LCD_POR_DIR  TRISB //Direccion, se configura como salida
    
    #define LCD_EN       LATAbits.LA0                     // LCD enable
    #define LCD_RW       LATAbits.LA1                      // LCD read/write line
    #define LCD_RS       LATAbits.LA2                      // LCD register select line

    #define LCD_EN_DIR   TRISAbits.TRISA0
